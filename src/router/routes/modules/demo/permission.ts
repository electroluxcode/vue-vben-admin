      ...
      children: [
        {
          path: 'page',
          name: 'FrontPageAuth',
          component: () => import('@project/views/demo/permission/front/index.vue'),
          meta: {
        ...
        },
        {
          path: 'btn',
          name: 'FrontBtnAuth',
          component: () => import('@project/views/demo/permission/front/Btn.vue'),
          meta: {
        ...
        },
        {
          path: 'auth-pageA',
          name: 'FrontAuthPageA',
          component: () => import('@project/views/demo/permission/front/AuthPageA.vue'),
          meta: {
        ...
        },
        {
          path: 'auth-pageB',
          name: 'FrontAuthPageB',
          component: () => import('@project/views/demo/permission/front/AuthPageB.vue'),
          meta: {
      ...
      children: [
        {
          path: 'page',
          name: 'BackAuthPage',
          component: () => import('@project/views/demo/permission/back/index.vue'),
          meta: {
        ...
        },
        {
          path: 'btn',
          name: 'BackAuthBtn',
          component: () => import('@project/views/demo/permission/back/Btn.vue'),
          meta: {
