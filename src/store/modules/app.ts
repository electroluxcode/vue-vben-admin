import type {
  ...
  TransitionSetting,
  MultiTabsSetting,
} from '@projectType/config';
import type { BeforeMiniState, ApiAddress } from '@projectType/store';

import { defineStore } from 'pinia';
import { store } from '@project/store';

import { ThemeEnum } from '@project/enums/appEnum';
import { APP_DARK_MODE_KEY, PROJ_CFG_KEY, API_ADDRESS } from '@project/enums/cacheEnum';
import { Persistent } from '@project/utils/cache/persistent';
import { darkMode } from '@project/settings/designSetting';
import { resetRouter } from '@project/router';
