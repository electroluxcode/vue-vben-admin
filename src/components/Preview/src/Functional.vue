<script lang="tsx">
  ...
  import resumeSvg from '@project/assets/svg/preview/resume.svg';
  import rotateSvg from '@project/assets/svg/preview/p-rotate.svg';
  import scaleSvg from '@project/assets/svg/preview/scale.svg';
  import unScaleSvg from '@project/assets/svg/preview/unscale.svg';
  import unRotateSvg from '@project/assets/svg/preview/unrotate.svg';
