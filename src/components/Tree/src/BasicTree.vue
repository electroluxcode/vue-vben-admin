<script lang="tsx">
  ...
  import { isArray, isBoolean, isEmpty, isFunction } from '@project/utils/is';
  import { extendSlots, getSlot } from '@project/utils/helper/tsxHelper';
  import { filter, treeToList, eachTree } from '@project/utils/helper/treeHelper';
  import { useTree } from './hooks/useTree';
  import { useContextMenu } from '@project/hooks/web/useContextMenu';
  import { CreateContextOptions } from '@project/components/ContextMenu';
  import { treeEmits, treeProps } from './types/tree';
  import { createBEM } from '@project/utils/bem';
